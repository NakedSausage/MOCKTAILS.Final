...
@Metadata(
        ...
        d2 = {"Lcom/example/midterm_exam/BerryActivity;", "Landroidx/appcompat/app/AppCompatActivity;", "()V", "initData", "", "onCreate", "savedInstanceState", "Landroid/os/Bundle;", "app_debug"}
)
public final class BerryActivity extends AppCompatActivity {
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        this.setContentView(R.layout.activity_berry);
        this.initData();
    }
