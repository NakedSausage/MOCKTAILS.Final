...
import com.example.mocktails.R;
...
@Metadata(
        ...
        d2 = {"Lcom/example/midterm_exam/CranberryActivity;", "Landroidx/appcompat/app/AppCompatActivity;", "()V", "initData", "", "onCreate", "savedInstanceState", "Landroid/os/Bundle;", "app_debug"}
)
public final class CranberryActivity extends AppCompatActivity {
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        this.setContentView(R.layout.activity_cranberry);
        this.initData();
    }
